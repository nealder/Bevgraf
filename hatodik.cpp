...
//createNMatrix();
	...
	W[0] = initPoint3dh(0.5,2.5,-0.5);
	W[1] = initPoint3dh(-0.5,2.5,-0.5);
	W[2] = initPoint3dh(-0.5,-1.5,-0.5);
	W[3] = initPoint3dh(0.5,-1.5,-0.5);
	W[4] = initPoint3dh(0.5,2.5,0.5);
	W[5] = initPoint3dh(-0.5,2.5,0.5);
	W[6] = initPoint3dh(-0.5,-1.5,0.5);
	W[7] = initPoint3dh(0.5,-1.5,0.5);

	E[0] = initPoint3dh(0.5,0.5,-0.5);
	E[1] = initPoint3dh(-0.5,0.5,-0.5);
	E[2] = initPoint3dh(-0.5,-0.5,-0.5);
	E[3] = initPoint3dh(0.5,-0.5,-0.5);
	E[4] = initPoint3dh(0.5,0.5,0.5);
	E[5] = initPoint3dh(-0.5,0.5,0.5);
	E[6] = initPoint3dh(-0.5,-0.5,0.5);
	E[7] = initPoint3dh(0.5,-0.5,0.5);

	R[0] = initPoint3dh(0.5,0.5,-0.5);
	R[1] = initPoint3dh(-0.5,0.5,-0.5);
	R[2] = initPoint3dh(-0.5,-0.5,-0.5);
	R[3] = initPoint3dh(0.5,-0.5,-0.5);
	R[4] = initPoint3dh(0.5,0.5,0.5);
	R[5] = initPoint3dh(-0.5,0.5,0.5);
	R[6] = initPoint3dh(-0.5,-0.5,0.5);
	R[7] = initPoint3dh(0.5,-0.5,0.5);

	A[0] = initPoint3dh(0.5,0.5,-0.5);
	A[1] = initPoint3dh(-0.5,0.5,-0.5);
	...
	S[0] = initPoint3dh(0.5,0.5,-0.5);
	S[1] = initPoint3dh(-0.5,0.5,-0.5);
	S[2] = initPoint3dh(-0.5,-0.5,-0.5);
	S[3] = initPoint3dh(0.5,-0.5,-0.5);
	S[4] = initPoint3dh(0.5,0.5,0.5);
	S[5] = initPoint3dh(-0.5,0.5,0.5);
	S[6] = initPoint3dh(-0.5,-0.5,0.5);
	S[7] = initPoint3dh(0.5,-0.5,0.5);
	...
	D[6] = initPoint3dh(-0.5,-0.5,0.5);
	D[7] = initPoint3dh(0.5,-0.5,0.5);
